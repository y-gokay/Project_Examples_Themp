...
import { Home, User, Building2, Eye, EyeOff, Moon, Sun } from "lucide-react";
...
const BusinessLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      ...
      setTimeout(() => {
        navigate(ROUTES.EMPLOYER_PANEL);
      }, 500);
    } else {
  ...
  return (
    <div className="min-h-screen flex relative bg-gradient-to-br from-blue-50 to-white dark:from-gray-900 dark:to-gray-800">
      <SEOHead title="İşveren Girişi" path="/isveren/giris" noindex />
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-end">
                <Link
                  to={ROUTES.EMPLOYER_FORGOT_PASSWORD}
