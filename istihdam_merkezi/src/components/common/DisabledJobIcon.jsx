...
/**
 * Engelli bireylere uygun ilanlar için özel ikon
 * Font Awesome Free v7 tabanlı SVG'den dönüştürülmüştür.
 */
const DisabledJobIcon = ({ className = "", title = "Engelli Bireyler İçin", ...props }) => {
  return (
    <svg
...
export default DisabledJobIcon;
